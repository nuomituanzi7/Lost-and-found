(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
    ...
    "2a4b": function (t, n, e) {
      ...
      (function (t) {
        ...
        var i = {
          ...
          methods: {
            onPayTap: function () {
              t.setStorageSync("paytable", "yonghu"), t.setStorageSync("payObject", this.detail), this.$utils.jump("../pay-confirm/pay-confirm?type=1")
            },
            onAcrossTap: function (n) {
              t.setStorageSync("crossTable", "yonghu"), t.setStorageSync("crossObj", this.detail), this.$utils.jump("../".concat(n, "/add-or-update?cross=true"))
            },
            init: function () {
              var t = this;
              return u(a.default.mark((function n() {
                ...
                return a.default.wrap((function (n) {
                  while (1) switch (n.prev = n.next) {
                    case 0:
                      return n.next = 2, t.$api.info("yonghu", t.id);
                    case 2:
                      e = n.sent, t.detail = e.data, t.swiperList = t.detail.touxiang ? t.detail.touxiang.split(",") : [];
                    case 5:
                    case "end":
                      return n.stop()
                  }
            ...
            onCommentTap: function () {
              this.$utils.jump("../discussyonghu/add-or-update?refid=".concat(this.id))
            },
            zan: function () {
              var n = this;
              return u(a.default.mark((function e() {
                            ...
                            return a.default.wrap((function (t) {
                              while (1) switch (t.prev = t.next) {
                                case 0:
                                  ...
                                  return r.detail.thumbsupnum = parseInt(r.detail.thumbsupnum) + 1, t.next = 4, r.$api.update("yonghu", r.detail);
                                case 4:
                                  r.$utils.msg("点赞成功");
                                case 5:
                                case "end":
                            ...
                            return a.default.wrap((function (t) {
                              while (1) switch (t.prev = t.next) {
                                case 0:
                                  ...
                                  return r.detail.crazilynum = parseInt(r.detail.crazilynum) + 1, t.next = 4, r.$api.update("yonghu", r.detail);
                                case 4:
                                  r.$utils.msg("点踩成功");
                                case 5:
                                case "end":
              ...
              return u(a.default.mark((function n() {
                return a.default.wrap((function (n) {
                  while (1) switch (n.prev = n.next) {
                    ...
                    case 6:
                      return "通过" == t.detail.sfsh && (t.detail.sfsh = "是"), "不通过" == t.detail.sfsh && (t.detail.sfsh = "否"), n.next = 10, t.$api.update("yonghu", t.detail);
                    case 10:
  ...
  [
    ["13e7", "common/runtime", "common/vendor"]
  ]
]);