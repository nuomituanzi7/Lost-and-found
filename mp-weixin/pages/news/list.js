(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/news/list"], {
    ...
    4882: function (t, e, n) {
      ...
      n("565b");
      var i, u = n("f0c5"),
        c = Object(u["a"])(a["default"], r["b"], r["c"], !1, null, null, null, !1, r["a"], i);
      e["default"] = c.exports
    },
    "565b": function (t, e, n) {
      "use strict";
          ...
          methods: {
                  ...
                  while (1) switch (n.prev = n.next) {
                    case 0:
                      return a = {
                        page: t.num,
                        limit: t.size
                      }, n.next = 3, e.$api.list("news", a);
                    case 3:
                      s = n.sent, 1 == t.num && (e.list = []), e.list = e.list.concat(s.data.list), 0 == s.data.list.length && (e.hasNext = !1), t.endSuccess(t.size, e.hasNext);
                    case 8:
                    case "end":
                      return n.stop()
                  }
            ...
            onDeleteTap: function (e) {
              ...
              t.showModal({
                ...
                content: "是否确认删除",
                success: function () {
                  var t = i(r.default.mark((function t(a) {
                ...
                return r.default.wrap((function (e) {
                  while (1) switch (e.prev = e.next) {
                    case 0:
                      ...
                      }, t.searchForm.title && (n["title"] = "%" + t.searchForm.title + "%"), e.next = 5, t.$api.list("news", n);
                    case 5:
  ...
  [
    ["572a", "common/runtime", "common/vendor"]
  ]
]);