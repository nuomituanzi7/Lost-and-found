  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.wupintupian" label="物品图片" prop="wupintupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.wupintupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="拾取时间" prop="shiqushijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.shiqushijian" label="拾取时间" prop="shiqushijian">
              <el-input v-model="ruleForm.shiqushijian" 
                placeholder="拾取时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="拾取地点" prop="shiqudidian">
          <el-input v-model="ruleForm.shiqudidian" 
              placeholder="拾取地点" clearable  :readonly="ro.shiqudidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="拾取地点" prop="shiqudidian">
              <el-input v-model="ruleForm.shiqudidian" 
                placeholder="拾取地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shiqushijian = true;
            continue;
	            	            ...
	            	            if(o=='shiqudidian'){
            this.ruleForm.shiqudidian = obj[o];
	    this.ro.shiqudidian = true;
            continue;
          }
	            	            if(o=='lianxidianhua'){
