		    ...
		    label="举报内容">
		     <template slot-scope="scope">
                       {{scope.row.jubaoneirong}}
                	                	                                      ...
                	                	                                      <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="xiangguanpingzheng"
                    header-align="center"
                    width="200"
                    label="相关凭证">
                    <template slot-scope="scope">
                      <div v-if="scope.row.xiangguanpingzheng">
                        <img :src="scope.row.xiangguanpingzheng.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    shDialog(row){
      ...
      if(row){
        this.shForm = {
                    ...
                    xiangguanpingzheng: row.xiangguanpingzheng,
