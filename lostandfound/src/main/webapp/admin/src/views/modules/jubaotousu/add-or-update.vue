  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.bianhao" label="编号" prop="bianhao">
              <el-input v-model="ruleForm.bianhao" 
                placeholder="编号" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info' && !ro.xiangguanpingzheng" label="相关凭证" prop="xiangguanpingzheng">
          <file-upload
          tip="点击上传相关凭证"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.xiangguanpingzheng?ruleForm.xiangguanpingzheng:''"
          @change="xiangguanpingzhengUploadChange"
          ></file-upload>
        </el-form-item>
        <div v-else>
          <el-form-item v-if="ruleForm.xiangguanpingzheng" label="相关凭证" prop="xiangguanpingzheng">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.xiangguanpingzheng.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="举报时间" prop="jubaoshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jubaoshijian" label="举报时间" prop="jubaoshijian">
              <el-input v-model="ruleForm.jubaoshijian" 
                placeholder="举报时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                        </el-row>
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="举报内容" prop="jubaoneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jubaoneirong" label="举报内容" prop="jubaoneirong">
  ...
  methods: {
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                ...
                                                xiangguanpingzhengUploadChange(fileUrls) {
                this.ruleForm.xiangguanpingzheng = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                                                    	addEditStyleChange() {
	  this.$nextTick(()=>{
