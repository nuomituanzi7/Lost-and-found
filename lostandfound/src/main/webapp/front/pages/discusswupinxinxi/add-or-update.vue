	...
	<view class="content">
		<form class="app-update-pv">
			...
			<!-- ${location} -->
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(147, 193, 7, 1)","textAlign":"left"}' class="title">评论内容</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusswupinxinxi`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																				...
																																																																				if(this.ruleForm.id){
					await this.$api.update(`discusswupinxinxi`, this.ruleForm);
				}else{
					await this.$api.add(`discusswupinxinxi`, this.ruleForm);
				}
