...
public class WupinfenleiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,WupinfenleiEntity wupinfenlei, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,WupinfenleiEntity wupinfenlei, HttpServletRequest request){
        EntityWrapper<WupinfenleiEntity> ew = new EntityWrapper<WupinfenleiEntity>();
		PageUtils page = wupinfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, wupinfenlei), params), params));
        return R.ok().put("data", page);
    }
